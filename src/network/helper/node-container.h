...
public:
  ...
  void Create (uint32_t n);
    ...
    //create npu nodes
  void createNpu (uint32_t n, uint32_t areaId);
  void createSw (uint32_t num , uint32_t areaId);
  void createInnerL1 (uint32_t num , uint32_t areaId);
  void createOuterL1 (uint32_t num , uint32_t areaId);

  void createSw (uint32_t num , uint32_t areaId, uint32_t systemId);
  void createNpu (uint32_t num , uint32_t areaId, uint32_t systemId);
  void createInnerL1 (uint32_t num , uint32_t areaId, uint32_t systemId);
  void createOuterL1 (uint32_t num , uint32_t areaId, uint32_t systemId);
